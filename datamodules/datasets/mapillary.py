...
class Mapillary(Dataset):
    ...
    def __init__(self, hparams, transform=None, mode='train', labels_mode="v2"):
        super().__init__()
        ...
        images_path = os.path.join(hparams.MAPILLARY_ROOT, mode_folder, "images")
        labels_path = os.path.join(hparams.MAPILLARY_ROOT, mode_folder, "labels")
    ...
    def __getitem__(self, index):
        ...
        # change 65 to 255 in order to blend with cityscapes labels
        target[target == 65] = 255
